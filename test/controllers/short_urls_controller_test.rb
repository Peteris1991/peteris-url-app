...
class ShortUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create short_url" do
    assert_difference('ShortUrl.count') do
      post short_urls_url, params: { short_url: { mini_url: @short_url.mini_url, original_url: @short_url.original_url } }
    end
  ...
  test "should update short_url" do
    patch short_url_url(@short_url), params: { short_url: { mini_url: @short_url.mini_url, original_url: @short_url.original_url } }
